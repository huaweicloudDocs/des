...
5.  输入“传输信息”。选择“Teleport方式”传输方式，根据实际情况输入必填项“Teleport规格”“预估数据传输天数”和“传输配置”，如[图2](#fig109565610320)。
...
6.  选择收货地址。首次创建服务单需要新建收货地址，用于华为数据中心邮寄Teleport给用户，需输入内容如[图3](#fig19986201415315)。
